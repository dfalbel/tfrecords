...
void InitDefaultsSequenceExample() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSequenceExampleImpl);
}
...
void AddDescriptorsImpl() {
  ...
  ::protobuf_feature_2eproto::AddDescriptors();
}
...
SequenceExample::SequenceExample()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_example_2eproto::InitDefaultsSequenceExample();
  }
  SharedCtor();
